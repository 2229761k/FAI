...
parser.add_argument('--input_size',       default=400,     type=int,   help='input size')
...
parser.add_argument('--max_step',         default=300,    type=int,   help='maximum step for training')
...
parser.add_argument('--log_step',         default=1,     type=int,   help='step for logging in iteration')
parser.add_argument('--save_step',        default=5,     type=int,   help='step for saving in epoch')
parser.add_argument('--data_dir',         default='/media/doh/ECECE209ECE1CDC0/research/cats_and_dogs/dataset/dogs_and_cats/sampled/train/',               help='data directory')
